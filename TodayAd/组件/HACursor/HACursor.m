...
#define defBackgroundColor [UIColor groupTableViewBackgroundColor]
...
- (HARootScrollView *)rootScrollView{
    if (!_rootScrollView) {
        ...
        _rootScrollView.backgroundColor = [UIColor groupTableViewBackgroundColor];
...
- (HAScrollNavBar *)scrollNavBar{
    if (!_scrollNavBar) {
        ...
        _scrollNavBar.backgroundColor = AppCOLOR;//[UIColor redColor];
        //_scrollNavBar.titleNormalColor = [UIColor grayColor];
...
- (HASortItemView *)sortItmView{
    if (!_sortItmView) {
        ...
        _sortItmView.backgroundColor = [UIColor whiteColor];
...
- (void)layoutSubviews{
    ...
    if (self.showSortbutton) {
        ...
        CGFloat sortItemH = Main_Screen_Height - SortItemViewY;
