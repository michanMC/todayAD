...
- (void)setup{
    ...
    self.layer.borderColor = [UIColor grayColor].CGColor;//[UIColor colorWithRed:126/255.0 green:222/255.0 blue:184/255.0 alpha:0.6].CGColor;
    self.titleLabel.font = [UIFont boldSystemFontOfSize:15];
    self.backgroundColor = [UIColor whiteColor];//[UIColor colorWithRed:31/255.0 green:192/255.0 blue:120/255.0 alpha:0.6];
