...
//#import "GuangZhouViewController.h"
...
- (instancetype)initWithFrame:(CGRect)frame title:(NSString*)title{
    ...
    if(self){
        ...
        if ([title isEqualToString:@"推荐"]) {
            RecommendView * ctl = [[RecommendView alloc]initWithFrame:self.bounds];
            [self addSubview:ctl];
        
        }
       else {
           GuangZhouView * ctl = [[GuangZhouView alloc]initWithFrame:self.bounds];
           [self addSubview:ctl];
