...
@implementation recom2TableViewCell
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        y = 20;
        for (int i = 0; i < 3; i++) {
            UIImageView * _imgView = [[UIImageView alloc]initWithFrame:CGRectMake(x, y, width, height)];
