...
@interface zhizuoViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>{
    ...
    NSString * _shujukuStr;//数据库
    NSString * _pinpaiStr;//品牌
    NSString * _jiageStr;//价格
    NSString * _jisuanStr;//计算
    NSString * _jieshaoStr;//介绍

    
    NSString * _miaoshuStr;//安装描述
    NSString * _minStr;//最小
    NSString * _shouhuoStr;//售后
    NSString * _fuwuStr;//服务
...
- (void)viewDidLoad {
    [super viewDidLoad];
    lblArray = @[@[@"",@"制作标题",@"类型",@"服务商品牌",@"价格",@"计算单位",@"制作介绍"],@[@"",@"安装描述",@"最小起订量",@"售后描述",@"服务区域"]];
    palblArray = @[@[@"",@"制作内容",@"数据库",@"用户填写",@"21元/单位",@"个",@"输入减介"],@[@"",@"请输入",@"个",@"请输入",@"地区"]];
    _section1 = 1;
